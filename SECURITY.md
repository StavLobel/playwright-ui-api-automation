...
3. Prepare fixes for all supported versions. These fixes will be released as new patch versions.

We ask that you contact us via the email provided above and give the project contributors a chance to resolve the vulnerability and issue a new release prior to any public exposure; this helps protect the project's users, and provides them with a chance to upgrade and/or update in order to protect their applications.
